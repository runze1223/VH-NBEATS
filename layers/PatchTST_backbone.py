...
class PatchTST_backbone(nn.Module):
    ...
    def forward(self, z):                                                                   # z: [bs x nvars x seq_len]
        ...
        # model
        # var=self.activation(self.Linear(z.permute(0,1,3,2))) 
        # n_vars = var.shape[1]
        # var=torch.reshape(var, (var.shape[0]*var.shape[1],var.shape[2],var.shape[3])) 
        # var=self.normlaizaion(var)
        # var = torch.reshape(var, (-1,n_vars,var.shape[-2],var.shape[-1])) 
